...
('function r1({data:t,onAdd:l,onEdit:a,onDelete:e}){\n  let[n,u]=(0,W.useState)(""),[i,f]=(0,W.useState)("All"),[s,m]=(0,W.useState)("All"),[b,h]=(0,W.useState)("All"),[d,k]=(0,W.useState)("All");',
 'function r1({data:t,onAdd:l,onEdit:a,onDelete:e,onBulkDelete:q}){\n  let[n,u]=(0,W.useState)(""),[i,f]=(0,W.useState)("All"),[s,m]=(0,W.useState)("All"),[b,h]=(0,W.useState)("All"),[d,k]=(0,W.useState)("All"),[B,C]=(0,W.useState)(()=>new Set),J=(0,W.useRef)(null);'),
('      T=v.reduce((o,r)=>o+_n(r),0),E=v.reduce((o,r)=>o+(r.profitLoss??0),0),S=v.filter(o=>o.result==="Win").length,y=v.filter(o=>o.result==="Loss").length;\n  return(0,c.jsxs)',
 '      T=v.reduce((o,r)=>o+_n(r),0),E=v.reduce((o,r)=>o+(r.profitLoss??0),0),S=v.filter(o=>o.result==="Win").length,y=v.filter(o=>o.result==="Loss").length;\n  (0,W.useEffect)(()=>{C(x=>{let z=new Set([...x].filter(id=>t.bets.some(p=>p.id===id)));return z.size===x.size?x:z})},[t.bets]);\n  let A=v.length>0&&v.every(o=>B.has(o.id)),D=(id,checked,shift)=>{C(x=>{let z=new Set(x),anchor=J.current;if(shift&&anchor){let a=v.findIndex(o=>o.id===anchor),b=v.findIndex(o=>o.id===id);if(a>=0&&b>=0){let lo=Math.min(a,b),hi=Math.max(a,b);v.slice(lo,hi+1).forEach(o=>checked?z.add(o.id):z.delete(o.id))}else checked?z.add(id):z.delete(id)}else checked?z.add(id):z.delete(id);return z});J.current=id},H=()=>{J.current=null;C(x=>{let z=new Set(x);if(A)v.forEach(o=>z.delete(o.id));else v.forEach(o=>z.add(o.id));return z})},R=()=>{if(B.size&&q?.([...B])){C(new Set);J.current=null}};\n  return(0,c.jsxs)'),
